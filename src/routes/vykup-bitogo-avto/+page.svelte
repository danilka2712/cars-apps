...
<svelte:head>
    ...
    <meta
        name="description"
        content="Срочный выкуп битого автомобиля в любом состоянии. Выезжаем на осмотр сразу после обращения! · Более. 200 положительных отзывов. Выкупаем. дороже. конкурентов."
    />
    <meta
        name="keywords"
        content="Выкуп автомобиля, Продажа автомобиля, Автовыкуп, автомобиль, срочный выкуп,битый автомобиль, залоговый автомобиль, автомобиль не на ходу"
    />
</svelte:head>
<section
    id="main"
    ...
    <div class="lg:w-1/2">
        <div class="">
            <h1 class="lg:text-5xl text-3xl font-medium mb-4">
                Выкуп битого автомобиля <span class="text-green-600"
                    >в Омске</span
                >
            </h1>
            <p class="lg:text-lg text-black/70">
                Хотите быстро продать битый автомобиль без выставления
                объявления на «Авито» или «Дроме»? Тогда вы по адресу.
            </p>
        </div>
        <div class="mt-8">

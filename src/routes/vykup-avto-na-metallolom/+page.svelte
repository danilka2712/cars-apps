...
<svelte:head>
    ...
    <meta
        name="description"
        content="Выкуп автомобиля на металлолом в Омске.
    ...
    <div class="lg:w-1/2">
        <div class="">
            ...
            <p class="lg:text-lg text-black/70">
                Хотите продать автомобиль, который годен только на металлолом?
                Честно оценим его стоимость и купим неисправный транспорт
                сегодня же.
            </p>
        </div>
        <div class="mt-8">

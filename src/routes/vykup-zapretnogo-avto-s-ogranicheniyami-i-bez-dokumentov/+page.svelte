    ...
    <script type="application/ld+json">
        {
          ...
          "description": "Срочный выкуп запретного автомобиля в любом состоянии. Выезжаем на осмотр сразу после обращения! · Более. 200 положительных отзывов. Выкупаем. дороже. конкурентов",
          "address": {
             "@type": "PostalAddress",
             "addressRegion": "Омск",
